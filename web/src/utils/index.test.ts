import { getEnvVariable, formatBalance, formatChainAsNum, formatAddress, capitalize } from 'utils'; // Adjust the import path as needed
...
describe('Utility Functions', () => {
  describe('getEnvVariable', () => {
    ...
    it('should throw an error if the environment variable is not set', () => {
      expect(() => getEnvVariable('NON_EXISTENT_VAR')).toThrow('NON_EXISTENT_VAR not set');
    });
  });
