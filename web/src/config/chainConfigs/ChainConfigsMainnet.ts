import { CelestiaIcon, FlameIcon, MilkTiaIcon, NobleIcon, OsmosisIcon, StrideIcon, StrideTiaIcon, UsdcIcon } from "icons";
import type {
  CosmosChainInfo,
  CosmosChains,
  EvmChainInfo,
  ...
  currencies: [
    {
      ...
      sequencerBridgeAccount: "astria1dllx9d8karss9ca8le25a4vqhf67a67d5d4l6r",
