  ...
  return (
    <div className="root-container">
      ...
      <div className="item-container">
        <div className="item">
          <div className="item-title">Get TIA Address</div>
        ...
        <div className="item">
          <div className="item-title">Get TIA Balance</div>
        ...
        <div className="item">
          <div className="item-title">Send TIA</div>
