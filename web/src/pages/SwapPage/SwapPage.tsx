...
import { ActionButton, 
	...
	DialogFooter,
	DialogTitle,
	DialogDescription, } from "components";
		...
		<section className="min-h-[calc(100vh-85px-96px)] flex flex-col items-center justify-center">
			<div className="max-w-[480px] mx-auto rounded-2xl p-6 border border-solid border-transparent bg-radial-dark shadow-[inset_1px_1px_1px_-1px_hsla(0,0%,100%,0.5)]">
				...
				<div className="flex flex-col bg-neutral-800 rounded-md p-3">
					<div className="flex justify-between">
						...
						<div className="ml-3 flex items-center space-x-2">
							<Dialog>
								<DialogTrigger>TIA</DialogTrigger>
								<DialogContent>
								<DialogTitle>MY TITLE</DialogTitle>
									<div>THIS IS MY MODAL AND I DO WHAT I WANT</div>
								</DialogContent>
							</Dialog>
						</div>
					</div>
				...
				<div className="flex justify-center mt-2 mb-2">
					<ArrowUpDownIcon
						size={32}
						className="cursor-pointer hover:bg-black transition duration-300 rounded-xl"
					/>
				</div>
				<div className="flex flex-col bg-neutral-800 rounded-md p-3">
					<div className="flex justify-between">
